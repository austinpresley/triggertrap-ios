...
class ShutterButton: UIButton {
    ...
    var ringColor : UIColor = UIColor.shutterBridge_naturalColor(1.0) {
        didSet {
            refreshView()
        }
    }
    
    var centerColor : UIColor = UIColor.shutterBridge_primaryColor(1.0) {
        didSet {
            refreshView()
        }
    }
    
    var strokeColor : UIColor = UIColor.shutterBridge_foregroundColor(1.0) {
        didSet {
            refreshView()
        }
    }
    ...
    func performThemeUpdate() {
        ...
        ringColor = UIColor.shutterBridge_naturalColor(1.0)
        centerColor = UIColor.shutterBridge_primaryColor(1.0) 
        strokeColor = UIColor.shutterBridge_foregroundColor(1.0)
    }
    ...
    func startAnimating() {
        ...
        animating = true
//        } else {
//            ringColor = UIColor.shutterBridge_primaryColor(1.0)
//        }
    }
