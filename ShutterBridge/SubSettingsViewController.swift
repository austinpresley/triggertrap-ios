...
class SubSettingsViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.tableView.backgroundColor = UIColor.shutterBridge_fillColor()
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.font = UIFont.shutterBridge_metric_light(20.0)
        cell.textLabel?.textColor = UIColor.shutterBridge_accentColor(1.0)
        ...
        if value == (values[indexPath.row] as Int) {
            ...
            cell.tintColor = UIColor.shutterBridge_primaryColor(1.0)
        }
