...
class OptionsTableViewController: UIViewController {
    ...
    fileprivate func applyTheme() {
        ...
        self.navigationItem.rightBarButtonItem?.tintColor = UIColor.shutterBridge_iconColor()
        ...
        self.view.backgroundColor = UIColor.shutterBridge_naturalColor()
        self.tableView.backgroundColor = UIColor.shutterBridge_naturalColor()
...
extension OptionsTableViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if let options = options, let optionsSection = (options[indexPath.section] as? NSArray), let optionsInSection = optionsSection[1] as? NSArray, let option = optionsInSection[indexPath.row] as? NSDictionary {
            ...
            cell.icon.image = ImageWithColor(UIImage(named: option["icon"] as! String)!, color: UIColor.shutterBridge_iconColor())
            ...
            cell.square.backgroundColor = UIColor.shutterBridge_primaryColor()
