...
class PeekabooViewController: SensorViewController, FaceDetectorDelegate {
    ...
    override func performThemeUpdate() {
        ...
        faceDetectionViewController.rotationButton?.setImage(ImageWithColor(UIImage(named: "Camera-Rotate")!, color: UIColor.shutterBridge_fillColor()), for: UIControl.State())
