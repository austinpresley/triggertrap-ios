...
class SettingsTableViewController : UITableViewController {
    ...
    @IBAction func nightTimeSwitchValueChanged(_ nightTimeSwitch: UISwitch) {
        ...
        (UIApplication.shared.delegate as! AppDelegate).window?.backgroundColor = UIColor.shutterBridge_fillColor(1.0)
    ...
    fileprivate func performThemeUpdate() {
        ...
        self.navigationController?.navigationBar.tintColor = UIColor.shutterBridge_iconColor()
        ...
        nightModeCell.backgroundColor = UIColor.shutterBridge_fillColor()
        nightTimeLabel.textColor = UIColor.shutterBridge_accentColor()
        
        resetCell.backgroundColor = UIColor.shutterBridge_fillColor()
        resetCell.usesSmartColor = false
        resetCell.backgroundFadeColor = UIColor.shutterBridge_fillColor()
        resetLabel.textColor = UIColor.shutterBridge_primaryColor()
        
        self.tableView.backgroundColor = UIColor.shutterBridge_backgroundColor()
        self.tableView.separatorColor = UIColor.shutterBridge_foregroundColor()
        ...
        for i in 0..<numSections{
            ...
            header?.backgroundView?.backgroundColor = UIColor.shutterBridge_tableHeaderBackgroundColor()
        }
        
        self.tableView.reloadData()
        
        nightTimeSwitch.thumbTintColor = nightTimeSwitch.isOn ? UIColor.shutterBridge_fillColor() : UIColor.shutterBridge_foregroundColor()
        nightTimeSwitch.onTintColor = UIColor.shutterBridge_primaryColor()
    ...
    fileprivate func applyThemeToCell(_ cell: BFPaperTableViewCell, titleLabel: UILabel, descriptionLabel: UILabel) {
        ...
        if cell.accessoryType == .disclosureIndicator {
            cell.accessoryView = UIImageView(image: ImageWithColor(UIImage(named: "DisclosureIndicator")!, color: UIColor.shutterBridge_foregroundColor()))
            cell.accessoryView?.frame = CGRect(x: 0, y: 0, width: 8, height: 13)
        }
        
        cell.backgroundColor = UIColor.shutterBridge_fillColor()
        cell.usesSmartColor = false
        cell.backgroundFadeColor = UIColor.shutterBridge_fillColor()
        
        titleLabel.textColor = UIColor.shutterBridge_accentColor()
