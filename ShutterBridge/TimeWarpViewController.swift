...
class TimeWarpViewController: TTViewController, TTNumberInputDelegate, TTKeyboardDelegate, TTControlPointDelegate {
    ...
    override func viewDidLoad() {
        ...
        durationFeedbackLabel.boldFont = UIFont.shutterBridge_openSans_bold(17)
        durationFeedbackLabel.regularFont = UIFont.shutterBridge_openSans_regular(17)
        durationFeedbackLabel.font = UIFont.shutterBridge_openSans_regular(13)
        ...
        //TTShadeRedColour
        timeWarpInfoView.backgroundColor = UIColor.shutterBridge_shadeRedColor(1.0)
        
        //TTTimeWarpDarkRedColor
        visibleView.backgroundColor = UIColor.shutterBridge_timeWarpDarkRedColor(1.0)
    ...
    override func performThemeUpdate() {
        ...
        timeWarpView.backgroundColor = UIColor.shutterBridge_fillColor()
        timeWarpInfoView.backgroundColor = UIColor.shutterBridge_color(UIColor.shutterBridge_primaryColor(), change: 0.1)
        visibleView.backgroundColor = UIColor.shutterBridge_color(UIColor.shutterBridge_primaryColor(), change: 0.2)
        
        takeTextLabel.textColor = UIColor.shutterBridge_foregroundColor()
        exposuresTextLabel.textColor = UIColor.shutterBridge_foregroundColor()
        
        durationFeedbackLabel.textColor = UIColor.shutterBridge_fillColor()
        durationFeedbackLabel.updateApperance()
        
        durationLabel.textColor = UIColor.shutterBridge_fillColor()
        
        exposuresLabel.textColor = UIColor.shutterBridge_fillColor()
        exposuresFeedbackLabel.textColor = UIColor.shutterBridge_fillColor()
        
        applyThemeUpdateToNumberInput(photosNumberInputView) 
        applyThemeUpdateToTimeInput(durationNumberInputView)
        
        bezierGraphView.backgroundColor = UIColor.shutterBridge_fillColor()
        bezierGraphView.setCurve(UIColor.shutterBridge_primaryColor())
        bezierGraphView.setPointBorderColor(UIColor.shutterBridge_foregroundColor())
        bezierGraphView.setPointFill(UIColor.shutterBridge_naturalColor())
        bezierGraphView.setOverlappingExposuresColor(UIColor.shutterBridge_primaryColor())
        
        tickImageView.image = ImageWithColor(UIImage(named: "tickDown")!, color: UIColor.shutterBridge_fillColor())
        
        previewButton.setBackgroundImage(ImageWithColor(UIImage(named: "timeWarpPreviewButton")!, color: UIColor.shutterBridge_primaryColor()), for: UIControl.State())
        
        clockImageView.image = ImageWithColor(UIImage(named: "timeWarpClockCircle")!, color: UIColor.shutterBridge_primaryColor())
        
        clockCenterImageView.image = ImageWithColor(UIImage(named: "timeWarpClockCenter")!, color: UIColor.shutterBridge_primaryColor())
        
        clockHandleImageView.image = ImageWithColor(UIImage(named: "timeWarpClockHand")!, color: UIColor.shutterBridge_primaryColor())
    }
