...
class BrampingViewController: TTViewController, HorizontalPickerDelegate, TTNumberInputDelegate {
    ...
    override func viewDidLoad() {
        ...
        durationDisplayLabel.boldFont = UIFont.shutterBridge_openSans_bold(17.0)
        durationDisplayLabel.regularFont = UIFont.shutterBridge_openSans_regular(17.0)
        durationDisplayLabel.font = UIFont.shutterBridge_openSans_regular(13.0)
        durationDisplayLabel.textColor = UIColor.shutterBridge_accentColor(1.0)
    ...
    override func performThemeUpdate() {
        ...
        exposuresLabel.textColor = UIColor.shutterBridge_foregroundColor()
        intervalLabel.textColor = UIColor.shutterBridge_foregroundColor()
        
        durationLabel.textColor = UIColor.shutterBridge_foregroundColor()
        
        durationDisplayLabel.textColor = UIColor.shutterBridge_accentColor()
        durationDisplayLabel.updateApperance() 
        
        applyThemeUpdateToPicker(startExposurePicker)
        applyThemeUpdateToPicker(endExposurePicker)
        
        startExposureLabel.textColor = UIColor.shutterBridge_foregroundColor()
        endExposureLabel.textColor = UIColor.shutterBridge_foregroundColor()
    }
}
