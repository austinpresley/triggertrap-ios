...
class WearablesViewController: TTViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        segmentedControl.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.shutterBridge_metric_light(20.0)]
            , for: UIControl.State())
        segmentedControl.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.shutterBridge_metric_light(20.0)]
            , for: .selected)
    }
    ...
    override func performThemeUpdate() {
        ...
        segmentedControl.tintColor = UIColor.shutterBridge_primaryColor()
        infoText.textColor = UIColor.shutterBridge_foregroundColor()
    }
