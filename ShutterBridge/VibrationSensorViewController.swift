...
class VibrationSensorViewController: SensorViewController, CicularSliderDelegate {
    ...
    fileprivate func popNameLabelText(_ popLabel: Bool) {
        if popLabel {
            ...
            nameLabel.textColor = UIColor.shutterBridge_primaryColor(1.0)
        } else {
            if shouldPopNameLabel == true {
                shouldPopNameLabel = false
                pop(nameLabel, fromScale: 2.6, toScale: 1.0)
                nameLabel.textColor = UIColor.shutterBridge_foregroundColor(1.0)
            }
        }
    }
    ...
    override func performThemeUpdate() {
        ...
        circularSlider.minimumTrackTintColor = UIColor.shutterBridge_primaryColor()
        ...
        circularVibrationLevel.minimumTrackTintColor = UIColor.shutterBridge_primaryColor()
        circularVibrationLevel.maximumTrackTintColor = UIColor.shutterBridge_naturalColor()
        
        nameLabel.textColor = UIColor.shutterBridge_foregroundColor()
    }
