...
class LeHdrTimelapseViewController: TTViewController, TTNumberInputDelegate, TTNumberPadViewDelegate {
    ...
    override func performThemeUpdate() {
        ...
        middleExposureLabel.textColor = UIColor.shutterBridge_foregroundColor()
        timelapseIntervalLabel.textColor = UIColor.shutterBridge_foregroundColor()
        evLabel.textColor = UIColor.shutterBridge_foregroundColor()
    }
}
