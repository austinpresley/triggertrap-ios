...
class WiFiViewController: TTViewController {
    ...
    override func viewDidLoad() {
        ...
        wifiSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.shutterBridge_metric_light(20.0)]
            , for: UIControl.State())
        wifiSegmentedControl.setTitleTextAttributes([NSAttributedString.Key.font: UIFont.shutterBridge_metric_light(20.0)]
            , for: .selected)
    }
    ...
    override func performThemeUpdate() {
        ...
        wifiSegmentedControl.tintColor = UIColor.shutterBridge_primaryColor()
        wifiInfoText.textColor = UIColor.shutterBridge_foregroundColor()
    }
}
