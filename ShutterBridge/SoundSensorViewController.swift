...
class SoundSensorViewController: SensorViewController {
    ...
    override func performThemeUpdate() {
        ...
        circularSoundLevel.minimumTrackTintColor = UIColor.shutterBridge_primaryColor()
        circularSoundLevel.maximumTrackTintColor = UIColor.shutterBridge_naturalColor()
