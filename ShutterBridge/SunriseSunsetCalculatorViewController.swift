...
class SunriseSunsetCalculatorViewController: SplitLayoutViewController, CLLocationManagerDelegate {
    ...
    fileprivate func createWhiteViewContent() {
        ...
        sunImageView.image = (self.dayTimeStatus == DayTimeStatus.nightTime) ? ImageWithColor(UIImage(named: "solarCalculatorGreySun")!, color: UIColor.shutterBridge_foregroundColor()) : ImageWithColor(UIImage(named: "solarCalculatorRedSun")!, color: UIColor.shutterBridge_primaryColor())
        
        arcImageView.image = (self.dayTimeStatus == DayTimeStatus.nightTime) ? ImageWithColor(UIImage(named: "solarCalculatorArcFlipped")!, color: UIColor.shutterBridge_foregroundColor()) : ImageWithColor(UIImage(named: "solarCalculatorArc")!, color: UIColor.shutterBridge_foregroundColor())
    ...
    override func performThemeUpdate() {
        ...
        titleLabelTop.textColor = UIColor.shutterBridge_foregroundColor()
        timeLabelTop.textColor = UIColor.shutterBridge_primaryColor()
        timeRemainingLabelTop.textColor = UIColor.shutterBridge_accentColor()
        lightTimeLabelTop.textColor = UIColor.shutterBridge_accentColor()
        
        titleLabelBottom.textColor = UIColor.shutterBridge_foregroundColor()
        timeLabelBottom.textColor = UIColor.shutterBridge_primaryColor()
        timeRemainingLabelBottom.textColor = UIColor.shutterBridge_accentColor()
        lightTimeLabelBottom.textColor = UIColor.shutterBridge_accentColor()
        
        firstLightDiagramLabel.textColor = UIColor.shutterBridge_foregroundColor()
        sunriseDiagramLabel.textColor = UIColor.shutterBridge_foregroundColor()
        sunsetDiagramLabel.textColor = UIColor.shutterBridge_foregroundColor()
        lastLightDiagramLabel.textColor = UIColor.shutterBridge_foregroundColor()
        
        cityLabel.textColor = UIColor.shutterBridge_accentColor()
        
        flatLineImageView.image = ImageWithColor(UIImage(named: "solarCalculatorFlatFill")!, color: UIColor.shutterBridge_primaryColor())
        
        arcImageView.image = ImageWithColor(UIImage(named: "solarCalculatorArc")!, color: UIColor.shutterBridge_foregroundColor())
        sunImageView.image = ImageWithColor(UIImage(named: "solarCalculatorRedSun")!, color: UIColor.shutterBridge_primaryColor())
    }
}
